  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center text-center py-16 gap-6">
        <div className="w-16 h-16 rounded-full bg-green-500/20 border border-green-500/30 flex items-center justify-center text-2xl">
          ✓
        </div>
        <div>
      ...
      {step === 1 && (
        <div>
          ...
          <p className="text-white/70 text-center mb-8">
            All tickets are free. Select the one that fits you.
          </p>
